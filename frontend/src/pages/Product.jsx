                ...
                <div className='flex-1'>
                        ...
                        <div className='flex gap-2'>
                            {productData.sizes.map((item, index) => (
                                <button
                                    ...
                                    className={`w-10 h-10 flex items-center justify-center rounded-full border bg-gray-100 transition-all duration-300 transform ${
                    ...
                    <div className='flex space-x-8'>
                        <button
                            ...
                            className='bg-black text-white px-8 py-3 text-sm rounded-lg active:bg-gray-700 transition-all duration-300 transform hover:scale-105 hover:shadow-lg'
                        >
                            ADD TO CART
                        </button>
                        <button
                            onClick={() => navigate('/try-virtually')}
                            className='bg-black text-white px-8 py-3 text-sm rounded-lg active:bg-gray-700 transition-all duration-300 transform hover:scale-105 hover:shadow-lg'
                        >
                            TRY-ON VIRTUALLY
                        </button>
